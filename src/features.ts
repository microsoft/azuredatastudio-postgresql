...
export class AgentServicesFeature extends SqlOpsFeature<undefined> {
	...
	protected registerProvider(options: undefined): Disposable {
		...
		let getJobHistory = (connectionUri: string, jobID: string, jobName: string): Thenable<sqlops.AgentJobHistoryResult> => {
			let params: contracts.AgentJobHistoryParams = { ownerUri: connectionUri, jobId: jobID, jobName: jobName };
		...
		let jobAction = (connectionUri: string, jobName: string, action: string): Thenable<sqlops.ResultStatus> => {
			let params: contracts.AgentJobActionParams = { ownerUri: connectionUri, jobName: jobName, action: action };
